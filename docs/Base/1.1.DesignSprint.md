...
A sprint seguiu o seguinte fluxo, com os artefatos produzidos em cada etapa:
...
*Figura 2: Rich Picture do ecossistema G7_MonitoreSeuTreino. Autor: [Andre Meyer](https://github.com/andremeyerr).*
...
Nesta etapa, a equipe construirá o protótipo de alta fidelidade cobrindo o escopo do MVP, com base nas características definidas na [Visão do Produto](Base/1.1.1.VisaoProduto.md) e nos requisitos especificados no [documento de requisitos](Base/1.1.2.Requisitos.md).
...
| 1.5    | 04/04/2026 | Reorganização em documentos separados: Visão do Produto, Requisitos e Backlog | Lucas Antunes   | —               |
